...
unsigned char GetCRC8(unsigned char*, unsigned short, char);
...
unsigned short GetCRC16(unsigned char*, unsigned short, char);
// parameter - data buffer pointer, data length, option byte
// return - calcurated value
// option - CRC16 type defined value

unsigned long GetCRC32(unsigned char*, unsigned short, char);
// parameter - data buffer pointer, data length, option byte
// return - calcurated value
// option - CRC32 type defined value

...
unsigned char get_CRC8(unsigned char*, unsigned short, char);
...
unsigned short get_CRC16(unsigned char*, unsigned short, char);
// parameter - data buffer pointer, data length, option byte
// return - calcurated value
// option - 

long get_CRC32(unsigned char*, unsigned short, char);
// parameter - data buffer pointer, data length, option byte
// return - calcurated value
// option - */
